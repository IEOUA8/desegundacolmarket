    ...
    <main>
      ...
      <section className="container-shell grid min-h-[calc(100vh-80px)] place-items-center py-12">
        <div className="w-full max-w-md border border-[color:var(--line)] bg-white p-6">
          ...
          <h1 className="mt-2 font-serif text-4xl">Crear cuenta</h1>
          <p className="mt-3 text-sm leading-6 text-[color:var(--muted)]">
            Crea tu perfil para comprar, guardar favoritos y vender prendas.
          </p>
          <div className="mt-6">
          ...
          <p className="mt-5 text-sm text-[color:var(--muted)]">
            Ya tienes cuenta?{" "}
            <Link className="font-semibold text-[color:var(--ink)]" href="/login">
              Iniciar sesion
            </Link>
          </p>
        </div>
